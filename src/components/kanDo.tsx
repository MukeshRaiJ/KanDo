...
export default function HomePage() {
    ...
    try {
      const unsubscribeTasks = FirebaseService.subscribeToTasks(
        ...
        (tasks) => {
          ...
          setColumns([
            { ...columns[0], items: todoTasks },
            { ...columns[1], items: inProgressTasks },
            { ...columns[2], items: doneTasks },
          ]);
          setLoading(false);
        }
      );
  ...
  // Updated handleAddNote function with proper date handling
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 to-amber-100 dark:from-gray-900 dark:to-gray-800">
        <div className="text-center">
          <h1 className="text-3xl font-bold mb-4">Welcome to KanDo</h1>
          <p className="mb-4 text-gray-600 dark:text-gray-400">
            Please sign in to access your tasks and notes.
          </p>
          <Button
